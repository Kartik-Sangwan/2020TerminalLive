...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def attack(self, game_state):
        ...
        if self.scored_on_locations == []:
            game_state.attempt_spawn(INTERCEPTOR, [14, 0], 100)
        else:
    ...
    def build_defences(self, game_state):
        ...
        pink_destructors_points = [[4, 12], [8, 12], [12, 12], [16, 12], [
            20, 12], [25, 12], [23, 11], [6, 10], [10, 10], [14, 10], [18, 10]]
        pink_filters_points = [[0, 13], [1, 13], [2, 13], [
            3, 13], [4, 13], [25, 13], [26, 13], [27, 13]]

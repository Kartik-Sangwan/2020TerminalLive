...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def attack(self, game_state):
        if game_state.get_resource(BITS) >= 23:
            game_state.attempt_spawn(PING, [23,9], math.floor(game_state.get_resource(BITS)))
    ...
    def build_defences(self, game_state):
        ...
        pink_encryptors_points = [[10, 3], [11, 3], [12, 3], [13, 3], [14, 3], [15, 3], [16, 3], [17, 3], [11, 2], [12, 2], [13, 2], [14, 2], [15, 2], [16, 2], [12, 1], [13, 1], [14, 1], [15, 1], [13, 0], [14, 0]]
        pink_filters_points = [[9, 4], [10, 4], [11, 4], [12, 4], [13, 4], [14, 4], [15, 4], [16, 4], [17, 4], [18, 4]]
        blue_destructors_points = [[0, 13], [1, 13], [26, 13], [27, 13], [2, 12], [25, 12], [3, 11], [24, 11], [4, 10], [23, 10], [5, 9], [6, 8], [21, 8], [7, 7], [20, 7], [8, 6], [19, 6], [9, 5], [18, 5]]
